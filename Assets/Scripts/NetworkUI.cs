...
public class NetworkUI : MonoBehaviour
{
  ...
  public GameObject buttonPrefab, matchJoinPanelPrefab, levelSelectPanel, matchSelectPanel, errorMessageObject, graphicsSlider, graphicsText, muteButton, loadingPanel;
